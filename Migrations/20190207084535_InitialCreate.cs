        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ScheduledRuns_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WateringSchedules_ScheduledRuns_LastRunId",
                        column: x => x.LastRunId,
                        principalTable: "ScheduledRuns",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_WateringSchedules_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScheduledRuns_UserId",
                table: "ScheduledRuns",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_WateringSchedules_LastRunId",
                table: "WateringSchedules",
                column: "LastRunId");

            migrationBuilder.CreateIndex(
                name: "IX_WateringSchedules_UserId",
                table: "WateringSchedules",
                column: "UserId");
        }
